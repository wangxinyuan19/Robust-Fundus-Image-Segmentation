...
class NPY_datasets(Dataset):
    def __init__(self, path_Data, config, train=True):
        ...
        if train:
            images_list = sorted(os.listdir(path_Data+'training/images/'))
            masks_list = sorted(os.listdir(path_Data+'training/masks/'))
            self.data = []
            for i in range(len(images_list)):
                img_path = path_Data+'training/images/' + images_list[i]
                mask_path = path_Data+'training/masks/' + masks_list[i]
